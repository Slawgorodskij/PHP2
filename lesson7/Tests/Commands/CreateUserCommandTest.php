...
class CreateUserCommandTest extends TestCase
{
    ...
    {
        $createUserCommandHandler = new CreateUserCommandHandler(new DummyUsersRepository(), $this->getLogger());
    ...
    {
        $createUserCommandHandler = new CreateUserCommandHandler($this->makeUsersRepository(), $this->getLogger());
    ...
    public function testItSavesUserToRepository(): void
    {
        ...
        $createUserCommandHandler = new CreateUserCommandHandler($usersRepository, $this->getLogger());
